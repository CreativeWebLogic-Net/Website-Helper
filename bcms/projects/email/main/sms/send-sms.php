<?php
	...
	if($_GET['id']) $_SESSION['SMSID']=$_GET['id'];
...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><span class="pagetitle"><span class="pagetitle">Send SMS Messages - Step 1 </span><span class="RedText"><?php print $Message; ?></span></h1>
        ...
        <tr> 
          <td> The first step is to select who the emails are going to
            <table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td><form action="send-sms.php"  method="post" enctype="application/x-www-form-urlencoded" name="form2" >
                    <div align="center"><br>
                      Number Of Contacts Selected =<?=$c->NumberOfContactsSelected();?><br />
                      <br />
                    </div>
                 ...
                 ?>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="Posted" type="hidden" id="Posted" value="1" />
                          <input name="Filter" type="submit" class="formbuttons" id="Filter" value="Filter Again" /></td>
                      </tr>
                    </table>
                    <br>
                    <br>
