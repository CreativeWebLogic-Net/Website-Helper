...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><span class="pagetitle"><span class="pagetitle">Modify / Delete SMS Messages </span></h1>
                      ...
                      <?php
						...
						while ($myrow = mysql_fetch_row($sq2)) {
							...
							echo'<tr class="'.(($Count%2)==0 ? "row1" : "row2").'"> ';
							  echo"<td>$myrow[1]</td>";
							  echo"<td align=\"center\"><a href=\"send-sms.php?id=$myrow[0]\"><img src=\"../../images/select.gif\" width=\"47\" height=\"12\" border=\"0\"></a></td>";
