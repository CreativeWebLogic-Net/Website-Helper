...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right" ><a href="modify-streams.php">Modify / Delete Streams </a>| <a href="index-streams.php">Add Streams </a></td>
  </tr>
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><br><table width="98%" height="98" border="0" align="center" cellpadding="0" cellspacing="5" class="wizardStyle">
      ...
      <tr>
        <td height="17" valign="top" class="MainLinks"><span class="pagetitle"><span class="pagetitle">Modify Stream </span><span class="RedText"><?php print $Message; ?></span></h1>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><form action="modify-edit-streams.php"  method="post" name="form2" id="form2" onsubmit="YY_checkform('form2','Name','#q','0','You must fill in the field Name.');return document.MM_returnValue">
                          <br />
                        Complete the stream details below.<br />
                        <br />
                        ...
                        <table width="100%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
                          <tr>
                            ...
                            <td><input name="FromName" type="text" id="FromName" value="<?php print $Insert['FromName']; ?>" size="45" /></td>
                          </tr>
                          <tr>
                            <td><strong>From Email </strong></td>
                            <td><input name="FromEmail" type="text" id="FromEmail" value="<?php print $Insert['FromEmail']; ?>" size="45" /></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td height="25" colspan="2"><input name="Button2" type="button" class="formbuttons" onclick="MM_goToURL('self','modify-streams.php');return document.MM_returnValue;return confirmSubmit()" value="Cancel" />
