...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right" ><a href="modify-folders.php">Modify / Delete Folders </a>| <a href="index-folders.php">Add Folder </a> | <a href="modify.php">Inbox</a></td>
  </tr>
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><br><table width="98%" height="98" border="0" align="center" cellpadding="0" cellspacing="5" class="wizardStyle">
      ...
      <tr>
        <td height="17" valign="top" class="MainLinks"><span class="pagetitle"><span class="pagetitle">Modify Folder </span><span class="RedText"><?php print $Message; ?></span></h1>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><form action="modify-edit-folders.php"  method="post" name="form2" id="form2" onsubmit="YY_checkform('form2');return document.MM_returnValue">
                          <br />
                        ...
                        <table width="100%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
                          <tr>
                            <td width="163"><strong>Description <span class="RedText">*</span></strong></td>
                            <td width="352"><input name="Description" type="text" id="Description" value="<?php print $Insert['Description']; ?>" size="45" /></td>
                          </tr>
                          <tr>
                            <td height="25" colspan="2"><input name="Button2" type="button" class="formbuttons" onclick="MM_goToURL('self','modify-folders.php');return document.MM_returnValue;return confirmSubmit()" value="Cancel" />
