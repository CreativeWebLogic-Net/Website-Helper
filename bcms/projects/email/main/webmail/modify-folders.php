...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right" ><a href="index-folders.php">Add Folder </a></td>
  </tr>
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><table width="469" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="449"><span class="pagetitle"><span class="pagetitle">Modify / Delete Folders </span></span></td>
      </tr>
    </table>
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td>            <table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td><form action="modify-folders.php"  method="post" name="form2" >
						...
						while ($myrow = mysql_fetch_row($sq2)) {
							...
							?>
							 <tr class="<?=(($Count%2)==0 ? "row1" : "row2"); ?>">
							    <td><?=$myrow[1]?></td>
							    <td align="center"><a href="modify-edit-folders.php?id=<?=$myrow[0]?>" ><img src="../../images/modify.gif" width="47" height="12" border="0"></a></td>
					...
					?>
                      ...
                      <strong><br>
                      To Delete an Folder:</strong> select the checkbox for 
                      that Folder and then choose Delete button. <br>
                      <strong>Tip:</strong> You can select multiple Folders. 
                      <br>
                    </form></td>
                </tr>
            </table></td></tr>
