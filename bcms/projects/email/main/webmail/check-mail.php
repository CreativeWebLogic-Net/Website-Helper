<?php
	...
	$Count=0;
	$sql9 = $r->RawQuery("SELECT Server,User,Pass from Pop3 where ClientsID='$ClientsID'",$db);
	while ($myrow = mysql_fetch_row($sql9)) {
		$_SESSION['MAIL_HOST'][$Count]=$myrow[0];
		$_SESSION['USER_NAME'][$Count]=$myrow[1];
		$_SESSION['USER_PASS'][$Count]=$myrow[2];
		$Count++;
	};
	$_SESSION['Account_Max']=$Count;
...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><br><table width="98%" height="98" border="0" align="center" cellpadding="0" cellspacing="5" class="wizardStyle">
      ...
      <tr>
        <td height="17" valign="top" class="MainLinks"><span class="pagetitle"><span class="pagetitle">Check Webmail </span><span class="RedText"><?php print $Message; ?></span></h1>
            <p>
              <iframe src="getpop.php" width="500" marginwidth="0" height="200" marginheight="0" scrolling="Auto" frameborder="0"></iframe>
            </p>
