...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right" ><a href="modify-pop3.php">Modify/Delete Mailboxes </a> | <a href="modify.php">Inbox</a> | <a href="index-folders.php">Create Folders</a> | <a href="modify-folders.php">Modify/Delete Folders</a></td>
  </tr>
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><br><table width="98%" height="98" border="0" align="center" cellpadding="0" cellspacing="5" class="wizardStyle">
      ...
      <tr>
        <td height="17" valign="top" class="MainLinks"><span class="pagetitle"><span class="pagetitle">Add New Mailbox </span><span class="RedText"><?php print $Message; ?></span></h1>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><form action="index-pop3.php"  method="post" enctype="multipart/form-data" name="form2" id="form2" onsubmit="YY_checkform('form2');return document.MM_returnValue" >
                          <br />
                          <br />
                        ...
                        <table width="100%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
                          <tr>
                            <td width="178"><strong> Server <span class="RedText">*</span></strong></td>
                            <td width="337"><input name="Server" type="text" id="Server" size="45" /></td>
                          </tr>
                          <tr>
                            <td><strong> Username <span class="RedText">*</span> <span class="RedText"></span></strong></td>
                            <td><input name="User" type="text" id="User" size="45" /></td>
                          </tr>
                          <tr>
                            <td><strong>Password <span class="RedText">*</span> </strong></td>
                            <td><input name="Pass" type="password" id="Pass" size="45" /></td>
                          </tr>
                          <tr>
                            <td><strong>Folder To Move Emails To </strong></td>
