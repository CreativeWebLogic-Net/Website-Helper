...
width="944" height="878" id="DeleteAdministrator">
  <param name="movie" value="DeleteAdministrator.swf" />
  <param name="quality" value="high" />
  <param name="bgcolor" value="#FFFFFF" />
  <embed src="DeleteAdministrator.swf" quality="high" bgcolor="#FFFFFF" width="944" height="878"
name="DeleteAdministrator" align="" type="application/x-shockwave-flash"
