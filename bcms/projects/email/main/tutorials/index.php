...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="wrapper">
      <div id="content">
        <span class="pagetitle">Tutorials</h1>
        <p>&nbsp;</p>
        <p><a href="#" onclick="MM_openBrWindow('Add-Administrator','Tut','width=944,height=878')">Add Administrator</a><br />
            <a href="#" onclick="MM_openBrWindow('Delete-Administrator.php','Tut','width=944,height=878')">Delete Administrators <br />
             </a><a href="#" onclick="MM_openBrWindow('Modify-Administrator.php','Tut','width=944,height=878')">Modify Administrator</a></p>
        <p><a href="#" onclick="MM_openBrWindow('CreateAndSendEmail.php','Tut','width=944,height=878')">Create And Send Email</a> </p>
      </div>
        <div id="footer">
