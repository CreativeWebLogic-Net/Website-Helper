<?php
	...
	$r=new ReturnRecord();
	$rslt = $r->RawQuery("SELECT Verified FROM Administrators WHERE id='$_SESSION[AdminKey]'",$db);
...
<frameset rows="84,*,32" cols="*" framespacing="0" frameborder="no" border="0" id="VerticalFrameSet">
  ...
  <frame src="../submenus/home-frame.php" name="TheMainFrame" id="TheMainFrame" title="content" />
  <frame src="footer.php" name="bottomFrame" scrolling="No" noresize="noresize" id="bottomFrame" title="footer" />
</frameset>
<noframes><body>
</body>
</noframes></html>
