            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="top"><table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td valign="top"><form action="import2.php"  method="post" enctype="multipart/form-data" name="form2" id="form2" onsubmit="YY_checkform('form2');return document.MM_returnValue" >
                          <br />
                        Please select the CSV file on your computer to upload. <br />
                        <br />
                        <br />
                        ...
                        <table width="100%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
                          <tr>
                            <td width="163"><strong> File <span class="RedText">*</span></strong></td>
                            <td width="352"><input type="file" name="file" /></td>
                          </tr>
                          <? if($Theme!=2){ ?>
                          <? }; ?>
                          <tr>
                            <td><strong>Member Groups You wish the imported contacts will belong to </strong></td>
                            <td><select name="MemberGroupsID[]" size="7" multiple="multiple">
                              <?php
				  ...
				  ?>
                          ...
                          <tr>
                            <td height="25"><strong>Autoresponder Streams you wish to add the contacts to. </strong></td>
                            <td height="25"><select name="AR_StreamID[]" size="7" multiple="multiple" id="AR_StreamID" >
                              <?php
					  	$Count=0;
						...
						while ($myrow = mysql_fetch_row($sq2)) {
                          ...
                          <tr>
                            <td height="25">&nbsp;</td>
                            <td height="25"><input name="Submit" type="submit" class="formbuttons" value="Upload">
