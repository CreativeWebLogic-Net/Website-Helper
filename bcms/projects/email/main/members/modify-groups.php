...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="right" valign="top" ><a href="index-groups.php">Add Contact Group</a> | <a href="index.php">Add Contact</a> | <a href="modify.php">Modify / Delete Contacts</a> </td>
  </tr>
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><table width="469" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="449"><span class="pagetitle">Modify / Delete Contact Groups <span class="RedText"><?php print $Message; ?></span></span></td>
      </tr>
    </table>
          ...
          <tr>
            <td>
              <table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><form action="modify-groups.php"  method="post" name="form2" id="form2" >
                      <br />
                      <br />
                ...
                <tr class="header">
                  ...
                  <td width="22%"><strong>Group Members </strong></td>
                  
                  <td width="11%" align="center"><strong>Modify</strong></td>
			...
			while ($myrow = mysql_fetch_row($sq2)) {
				...
				echo'<tr class="'.(($Count%2)==0 ? "row1" : "row2").'"> ';
				  echo"<td>$myrow[1]</td>";
          		 echo"<td align=\"center\"><a href=\"members-groups.php?MemberGroupsID=$myrow[0]\"><img src=\"../../images/modify.gif\" width=\"47\" height=\"12\" border=\"0\"></a></td>";
				
				  echo"<td align=\"center\"><a href=\"modify-edit-groups.php?id=$myrow[0]\"><img src=\"../../images/modify.gif\" width=\"47\" height=\"12\" border=\"0\"></a></td>";
		...
		?>
              ...
              <br />
              <strong>To Delete a Contact Group:</strong> select the checkbox for that Contact Group and then choose Delete button. <br />
                                  <strong>Tip:</strong> You can select multiple Contact Groups. <br />
                                  <br />
                  </form></td>
                </tr>
            </table></td>
