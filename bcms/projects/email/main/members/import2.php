<?php
	...
	if($_POST['Submit']){
		...
		$_SESSION['CSVArray']=split("\n",$contents);
		$_SESSION['MemberGroupsID']=$_POST['MemberGroupsID'];
		$_SESSION['AR_StreamID']=$_POST['AR_StreamID'];
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="top"><table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td valign="top"><form action="import3.php"  method="post" enctype="multipart/form-data" name="form2" id="form2" onsubmit="YY_checkform('form2');return document.MM_returnValue" >
                          <br />
                        Please choose which fields you wish to map to from the imported file. <br />
                        <br />
                        <br />
                        <table width="100%" border="0" cellpadding="3" cellspacing="1" >
                          <tr class="header">
                            <td width="74%"><strong> Field Name</strong></td>
                            <td width="26%" colspan="2" align="center"><strong>Map To </strong><strong></strong></td>
                          </tr>
                          <?php
					  	$Headings=split(",",$_SESSION['CSVArray'][0]);
						foreach($Headings as $key=>$val){	
							$Count++;
							?>
                          <tr class="<?=(($Count%2)==0 ? "row1" : "row2"); ?>">
                            <td><?=$val?></td>
                            <td colspan="2" align="center"><select name="MapTo[<?=$key?>]">
                              <option value="">Dont Map</option>
                              <option >Name</option>
