<?php
	...
	$sq2 = $r->RawQuery("SELECT Name,Body FROM Email WHERE id='$EmailID'",$db);
	...
	$l->AddTable("Logs");
	$l->AddExtraFields(array("ClientsID"=>$ClientsID,"AdministratorsID"=>$AdminKey,"Message"=>$Body,'MsgType'=>"email","MsgTitle"=>$_SESSION['LogTitle']));
