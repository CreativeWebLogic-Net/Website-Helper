...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="81%" class="rightside"><br><table width="98%" height="98" border="0" align="center" cellpadding="0" cellspacing="5" class="wizardStyle">
      ...
      <tr>
        <td height="17" valign="top" class="MainLinks"><span class="pagetitle"><span class="pagetitle">Add New Message </span><span class="RedText"><?php print $Message; ?></span></h1>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="685" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="685"><form action="index.php"  method="post" name="form2" id="form2" onsubmit="YY_checkform('form2','Name','#q','0','You must fill in the field Name.');return document.MM_returnValue" >
                          <br />
                          <br />
                        ...
                        <table width="100%" height="669" border="0" cellpadding="3" cellspacing="1" id="tablecell">
                          ...
                          <tr>
                            <td width="592" height="28"><input name="Name" type="text" id="Name" size="45" /></td>
                          </tr>
                          <tr>
                            <td height="20"><strong>Content <span class="RedText">*</span></strong></td>
                          </tr>
                          <tr>
                            <td height="451"><textarea name="Body" cols="80" rows="35" id="Body"></textarea></td>
                          </tr>
                        </table>
                        <div align="right">
