<?php
	...
	if($_POST['Submit']){
		if($_POST['When']=="Now"){
			...
			header("Location: send-emails-now.php");
			exit();
		}else{
			$FList=serialize($_SESSION['FilterList']);
			$Stype=serialize($_SESSION['SSType']);
			$r->RawQuery("INSERT INTO EmailQueue (EmailID,TemplatesID,FilterList,SType,ToGo,FromName,FromEmail,AdministratorsID) VALUES('$_SESSION[EmailID]','$_SESSION[TemplatesID]','$FList','$Stype','$_POST[Year]-$_POST[Month]-$_POST[Day] $_POST[Hours]:$_POST[Minutes]:00','$_POST[FromName]','$_POST[FromEmail]','$AdminKey')");
			header("Location: send-emails-future.php");
			exit();
		}
	}
...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><br><table width="98%" height="98" border="0" align="center" cellpadding="0" cellspacing="5" class="wizardStyle">
      ...
      <tr>
        <td height="17" valign="top" class="MainLinks"><span class="pagetitle"><span class="pagetitle">Send Messages - Step 3 </span></h1>
                          ...
                          <tr>
                            <td> The second step is to select when the emails are sent
                              <table width="616" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="616"><form action="send-emails3.php"  method="post" name="form2" id="form2" >
                                        <br />
                                        <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" id="tablecell">
                                          ...
                                          <tr>
                                            <td height="27" align="center"><strong>From Name </strong></td>
                                            <td colspan="2"><input name="FromName" type="text" id="FromName" value="<?=$FromName?>" size="45" /></td>
                                          </tr>
                                          <tr>
                                            <td height="28" align="center"><strong>From Email </strong></td>
                                            <td colspan="2"><input name="FromEmail" type="text" id="FromEmail" value="<?=$FromEmail?>" size="45" /></td>
                                          </tr>
                                          <tr>
