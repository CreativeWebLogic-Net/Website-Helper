...
<div id="menu">
        ...
        <div id="menu-items">
			<a href="../api/index.php" target="mainFrame">API Setup </a>
            <?php if($_SESSION['SU']){ ?>
			<a href="/main/administrators/recipient-emails.php" target="mainFrame">Recipient Emails </a>
           
			<a href="../clients/index.php" target="mainFrame">Clients Add </a>
			<a href="../clients/modify.php" target="mainFrame">Clients Modify </a>
			<?
				};	
			?>
			        </div>
