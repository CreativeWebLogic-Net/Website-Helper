...
<div id="menu">
        ...
        <div id="menu-items">
            <?php 
				if($p->CheckCode(16)){?>
			<a href="/main/autoresponder/index-streams.php" target="mainFrame">Create Stream  </a>
            <?
					};
				if($p->CheckCode(17)){
				?>
			<a href="/main/autoresponder/modify-streams.php" target="mainFrame">Modify Streams </a>
            <?
					};	
			?>        </div>
