...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top"  class="rightside"><span class="pagetitle">Payment View </span><span class="RedText"><?php print $Message; ?></span></h1>
      <table width="100%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
        <tr>
          <td>&nbsp;</td>
          <td align="right"><a href="paypal-log.php">Back to log </a></td>
        </tr>
        <tr>
          <td bgcolor="#940000" class="tableHeaders"><span class="style1">Key</span></td>
          <td bgcolor="#940000" class="tableHeaders"><span class="style1">Value</span></td>
        </tr>
        <?
		$Count=0;
		foreach($Insert as $key=>$val){
			if(!is_numeric($key)){
				$Count++;
	?>
        <tr bgcolor="<?=(($Count%2)==0 ? "#F1F4F7" : "#FFFFFF");?>">
          <td width="163"><strong>
            <?=$key;?>
          </strong></td>
          <td width="352"><?=$val;?></td>
	...
	?>
        <tr>
          <td height="25" colspan="2" align="right"><a href="paypal-log.php">Back to log </a></td>
        </tr>
      </table>
    <p>&nbsp;</p></td>
  </tr>
