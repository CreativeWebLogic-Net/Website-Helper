<?php
	...
	if($_POST['Submit']){
		//copy($_FILES['file']['tmp_file'] , "../../templates/temp.zip" );
		$m= new AddToDatabase();
		$m->AddPosts($_POST,array("Thumbnail"=>$_FILES['Thumbnail']));
		$m->AddTable("Templates");
		$m->AddExtraFields(array("ClientsID"=>$ClientsID));
		if($_FILES['Thumbnail']['name']){
			$m->ResizeImage('Thumbnail',"../../templates/","200x150");
		}
		$m->DoStuff();
		$NewID=$m->ReturnID();
		...
		if(!file_exists("../../templates/$NewID")){
			$oldumask = umask(0);
			mkdir("../../templates/$NewID", 0777); // or even 01777 so you get the sticky bit set
			umask($oldumask);
		}
		
		$t=new Template();
		$t->RootPath("http://".$_SERVER['HTTP_HOST']."/templates/$NewID/");
		$t->Convert("../../templates/$NewID/",$_FILES['file']);
...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right" ><a href="modify.php">Modify / Delete Templates </a></td>
  </tr>
  <tr>
    ...
    <td width="81%" valign="top" class="rightside"><br><table width="98%" height="98" border="0" align="center" cellpadding="0" cellspacing="5" class="wizardStyle">
      ...
      <tr>
        <td height="17" valign="top" class="MainLinks"><span class="pagetitle"><span class="pagetitle">Add New Template </span><span class="RedText"><?php print $Message; ?></span></h1>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><form action="index.php"  method="post" enctype="multipart/form-data" name="form2" id="form2" onsubmit="YY_checkform('form2','Name','#q','0','You must fill in the field Name.');return document.MM_returnValue" >
                          <br />
                          <br />
                        Complete the template details below. <a href="example-template.zip">CLICK HERE TO DOWNLOAD EXAMPLE TEMPLATE </a><br />
                        <br />
                        ...
                        <table width="100%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
                          ...
                          <tr>
                            <td><strong> Zip File Upload<span class="RedText">*</span> <span class="RedText"></span></strong></td>
                          ...
                          <tr>
							...
							if($_SESSION['SU']){
								echo'<strong>Public</strong><input name="Public" type="checkbox" id="SU" value="Yes">';
							};
						?>
                            </td>
                          </tr>
