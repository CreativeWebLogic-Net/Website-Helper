    ...
    class clsInstall{
       public $output;
		...
		function start_up(){
			...
			if($this->var['domain_data']["dcmshost"]==""){
				$this->output='Welcome to the Bubble CMS Install Script.<br>';
				$this->output.='You are executing this script from:- <br><br>';
				$this->output.=$_POST['server_guid'];
				$this->output.='<br><br>Downloaded Bubble CMS Distributed Install Zip.<br><br>';
				$this->output.=$app_data['asset-sever'];
				$this->output.='downloads/Latest-BCMS_Distributed.zip<br><br>';
				$this->output.='<a href="/install.php?uri='.urlencode('/step-2/').'">Unzip Install File</a><br><br>';
				$this->output.='{{message}}';
			}else{
