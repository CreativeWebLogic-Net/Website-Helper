<?php
    ...
    class clsSystem Extends clsClassFactory{
        ...
        public function execute_webpage(){
            ...
            //echo "I Am Legendary 30000111234 \n";
            
            $this->Set_Content_Init();
            
            //echo "I Am Legendary 300001234 \n";
        ...
        function Set_App_Vars(){
            ...
            clsClassFactory::Create_Variables_Array(self::$vars);
		}
        ...
        function Set_Template($import_template=false){
        ...
        function Output_HTML(){
            ...
            $time_data=clsClassFactory::$all_vars['stats']->retrieve_time_samples();
            //print_r($time_data);
            self::$all_vars['log']->general("Time Statistics",8,$time_data);
